...
internal fun checkGenericBuildProperties(context: EmulatorCheckContext): FraudSignal? {
...
internal fun checkEmulatorHardware(context: EmulatorCheckContext): FraudSignal? {
...
internal fun checkQemuFiles(context: EmulatorCheckContext): List<FraudSignal> {
...
internal fun checkEmulatorManagementApps(context: EmulatorCheckContext): List<FraudSignal> {
    val currentTimestampMs = Clock.System.now().toEpochMilliseconds()
...
internal fun checkSensorDeficit(context: EmulatorCheckContext): FraudSignal? {
    val sensorCount = (
        try {
