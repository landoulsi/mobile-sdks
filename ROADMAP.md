...
- [x] [complexity: moderate] Add integrity detection showcase screen in :demo:app with real-time risk gauge, signal breakdown list, and threat inspection UI
- [x] [complexity: simple] Implement untrusted installer source detection using PackageManager installer package name and install source info in :integrity
