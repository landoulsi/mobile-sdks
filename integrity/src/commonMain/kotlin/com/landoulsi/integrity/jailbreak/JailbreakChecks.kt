...
internal const val SANDBOX_TEST_PATH = "/private/jailbreak_test_integrity.txt"

internal fun checkJailbreakApps(context: JailbreakCheckContext): List<IntegritySignal> {
...
internal fun checkSystemBinaries(context: JailbreakCheckContext): List<IntegritySignal> {
    val currentTimestampMs = Clock.System.now().toEpochMilliseconds()
...
internal fun checkForkCapability(context: JailbreakCheckContext): IntegritySignal? {
...
internal fun checkSandboxIntegrity(context: JailbreakCheckContext): IntegritySignal? {
...
internal fun checkDylibInjection(context: JailbreakCheckContext): List<IntegritySignal> {
    val currentTimestampMs = Clock.System.now().toEpochMilliseconds()
