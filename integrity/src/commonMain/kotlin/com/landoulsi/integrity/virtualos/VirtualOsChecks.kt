...
internal fun checkOwnPackageResolvable(context: VirtualOsCheckContext): IntegritySignal? {
    val isKnown = try {
...
internal fun checkUidMismatch(context: VirtualOsCheckContext): IntegritySignal? {
    val expectedUid = (
        try {
...
internal fun checkDataDirAnomaly(context: VirtualOsCheckContext): IntegritySignal? {
...
internal fun checkKnownContainerApps(context: VirtualOsCheckContext): List<IntegritySignal> {
